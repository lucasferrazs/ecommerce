...
$app->post("/checkout", function(){
	...
	if(!isset($_POST['desaddress']) || $_POST['desaddress'] === ''){
		Address::setMsgError("informe a rua.");
		header("Location: /checkout");
		exit;
	}
...
$app->post("/register", function(){
	...
	if(!isset($_POST['email']) || $_POST['email'] == ''){
		User::setErrorRegister("Preencha o email do usuario");
	...
	if(!isset($_POST['password']) || $_POST['password'] == ''){
		User::setErrorRegister("Preencha a senha do usuario");
	...
	{
		User::setErrorRegister("este endereço ja existe");
...
$app->post("/profile", function(){
	...
	if ($_POST['desemail'] !== $user->getdesemail()){
		if (User::checkLoginExist($_POST['desemail']) === true){
			User::setError("este email ja está cadastrado");
		}
	}
...
// DADOS DO BOLETO PARA O SEU CLIENTE
	...
	$dadosboleto["endereco2"] =  $order->getdesstate()."-". $order->getdescountry() ."-". $order->getdescity() ."-". $order->getdeszipcode() ;
